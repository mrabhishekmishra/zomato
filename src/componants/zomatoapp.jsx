...
const zomatoapp = () => {
  let [sherelink, usesherelink] = useState("email");
  let share = (e) => {
  ...
  console.log(sherelink);
  let radio = (e) => {

    let data = e.target.value;
    usesherelink(e.target.checked);
  };
  return (
    <>
      <div className=" container  m-auto  grid grid-cols-2 p-3">
        ...
        <div className=" p-5">
          <h1 className="font-[400] text-[45px] text-center">
            Get the zomato app{" "}
          </h1>
          <p className="text-[18px] text-star ">
          ...
          <div className="my-5">
            {
            (sherelink == 'email') ?  <input
            type="email"
            name=""
            id=""
            placeholder="Email"
            className="p-3 w-[70%] rounded-md text-[20px]"
          /> : <input
          type="number"
          name=""
          id=""
        ...
        />
            ...
            <button className="bg-[#c92020d9] rounded-md mx-1 text-[white] p-3">
              Share APP Link{" "}
            </button>
          ...
          <div className="flex justify-between w-[350px]">
            <button
              ...
              name="1"
            >
              <img src={Google} alt="" className="w-[100%] " name="0" />
            </button>
            <button className="w-[150px] border  rounded-md" onClick={share}>
              <img src={AppStor} alt="" className="w-[100%]" name="1" />
            </button>
          </div>
        </div>
      </div>
